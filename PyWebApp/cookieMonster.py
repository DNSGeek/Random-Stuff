...
def makeCookie(data: Any, key: bytes = b"") -> str:
    ...
    WARNING: The encryption key is embedded in the cookie itself. This provides
    tamper-evidence but NOT confidentiality against anyone who has read this
    source code. Do NOT use this to store sensitive data in production
    environments where users may be adversarial.
    """
    if not key:
